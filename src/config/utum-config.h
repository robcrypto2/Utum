/* src/config/utum-config.h.  Generated from utum-config.h.in by configure.  */
/* src/config/utum-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef UTUM_CONFIG_H

#define UTUM_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://utum.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Utum Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Utum Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "utum"
