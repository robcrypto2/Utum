...
public:
	...
	nMasternodeColleteralLimxDev = 3000; //Params().MasternodeColleteralLimxDev()
        ...
        const char* pszTimestamp = "Utum cryptocurrency";
	...
	//printf("%s\n", genesis.hashMerkleRoot.ToString().c_str());
        ...
        vSeeds.push_back(CDNSSeedData("seed1.utum.info", "seed1.utum.info"));
        vSeeds.push_back(CDNSSeedData("seed2.utum.info", "seed2.utum.info"));
        //vFixedSeeds.clear();
        //vSeeds.clear();
...
public:
    CTestNetParams()
    {
        ...
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 193);
        // Testnet Utum BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet Utum BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet Utum BIP44 coin type is '1' (All coin's testnet default)
