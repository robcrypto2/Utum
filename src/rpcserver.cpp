...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* UTUM features */
        {"utum", "masternode", &masternode, true, true, false},
        {"utum", "masternodelist", &masternodelist, true, true, false},
        {"utum", "mnbudget", &mnbudget, true, true, false},
        {"utum", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"utum", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"utum", "mnsync", &mnsync, true, true, false},
        {"utum", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"utum", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use utumd, or the -server option to utum-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> utum-cli " + methodname + " " + args + "\n";
}
