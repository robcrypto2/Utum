...
RESOURCES += src/qt/utum.qrc src/qt/utum_locale.qrc

TRANSLATIONS += src/qt/locale/utum_bg.ts \
                src/qt/locale/utum_de.ts \
                src/qt/locale/utum_en.ts \
                src/qt/locale/utum_es.ts \
                src/qt/locale/utum_fi.ts \
                src/qt/locale/utum_fr.ts \
                src/qt/locale/utum_it.ts \
                src/qt/locale/utum_ja.ts \
                src/qt/locale/utum_pl.ts \
                src/qt/locale/utum_pt.ts \
                src/qt/locale/utum_ru.ts \
                src/qt/locale/utum_sk.ts \
                src/qt/locale/utum_sv.ts \
                src/qt/locale/utum_vi.ts \
                src/qt/locale/utum_zh_CN.ts \
                src/qt/locale/utum_zh_TW.ts
